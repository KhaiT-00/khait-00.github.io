...
const momentsData = [
    {
        id: 0,
        description:
            "ลองเอารูปหนูในเครื่องมาทำดู รูปที่เก็บไว้ ส่วนใหญ่อ่ะนะ\n\nดูบนมือถือนะ ในคอมน่าจะเพี้ยนๆ😁",
        isTextOnly: true,
    },
    {
        id: 1,
        description:
            "รูปแรกๆที่แอบถ่ายไว้📸\nตอนนั้นบัวกำลังเล่นกีตาร์ พี่ว่าเท่ดีเลยเก็บเอาไว้\n\nลองแตะๆที่รูปดู",
    },
    {
        id: 3,
        description:
            "เซตนี้มาจากถ่ายรูปเล่นกันจากกล้องใหญ่กัน\nรูปเยอะอยู่แต่เอามาแค่นี้พอ",
    },
    {
        id: 4,
        description:
            "รูปวันเดียวกับที่เล่นกล้องกันเลยแต่บัวเอาไปแต่งมา รูปสวยมาก😊\n\nชอบรูปแรกมากๆ เวลาบัว focus ทำอะไรสักอย่างมุมเผลอน่ารักสุดๆ",
    },
    {
        id: 6,
        description:
            "รูปนี้ตอนที่ไปบางแสน🏖️\nตอนเช้าไปเดินถ่ายรูปด้วยกัน\n\nอย่างว่าเวลาบัว focus\nทำอะไรสักอย่างมันน่ารักดี",
    },
    {
        id: 7,
        description:
            "รูปนี้จำไม่ได้ว่าหนูไปถ่ายตอนไหน แต่ชอบนะ👏 ฟิลเซลฟี่น่ารักสดใส",
    },
    {
        id: 8,
        description:
    ...
    },
    {
        id: 17,
        description:
            "วันนั้นน่าจะกินเบียร์กันที่แลปกัน บัวโดนงานมาหนักจนร้องไห้เลย\nเป็นห่วงมากกเลย\n\nวันนั้นเฝ้าบัวนอนที่แลปรอหอเปิด\nตอนนอนก็ดูน่ารักดีนะ สงบดี",
    },
    {
        id: 18,
...
async function loadMomentsImages(onProgress) {
    const extensions = ["jpg"];
    const totalMoments = momentsData.length;
    let completedMoments = 0;

    if (onProgress) {
        onProgress(0, totalMoments);
    }

    await Promise.all(momentsData.map(async (moment) => {
        if (moment.isTextOnly) {
            completedMoments++;
            if (onProgress) {
                onProgress(completedMoments, totalMoments);
            }
            return;
        }
